...
namespace Inovuz\FileEsteroids;
 ...
 */
class FileEsteroids extends Field implements StorableContract, DeletableContract, DownloadableContract
{
     ...
     * @var string
     */
    public $component = 'file-esteroids';
